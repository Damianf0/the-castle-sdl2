...
Write-Host "OK -> $src\the_castle.exe ($([math]::Round((Get-Item "$src\the_castle.exe").Length/1KB,0)) KB)" -ForegroundColor Green
Write-Host "Correr: .\the_castle.exe" -ForegroundColor Green
