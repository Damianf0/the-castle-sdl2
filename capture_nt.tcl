# Vuelca la NAME TABLE original (VRAM 0x1800, 768 bytes, índices de tile 0-255
# SIN deduplicar) de las 100 salas -> ont_XX.bin. Es el dato que usa la lógica
...
set ::idx -1
proc dumpnt {rx} {
    set f [open [format "ont_%02X.bin" $rx] w]; fconfigure $f -translation binary
